...
--
-- v5 (2026-09-12): every fixture entry carries "status":"closed" — the column
-- is NOT NULL and jsonb_populate_recordset writes NULL for an absent key. A
-- payload from src/lib/import-remap.ts always carries it; these hand-written
-- ones must too. ro_events is exercised by the unit guards, not here.
